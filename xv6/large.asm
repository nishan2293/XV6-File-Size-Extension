...
main()
{
  ...
  6e:	75 c8                	jne    38 <main+0x38>
		printf(2, ".");
  70:	c7 44 24 04 73 08 00 	movl   $0x873,0x4(%esp)
  77:	00 
  ...
  8c:	c7 44 24 04 75 08 00 	movl   $0x875,0x4(%esp)
  93:	00 
  ...
  ff:	c7 44 24 04 f0 08 00 	movl   $0x8f0,0x4(%esp)
 106:	00 
 ...
 113:	e8 9a 02 00 00       	call   3b2 <exit>
  ...
  printf(1, "done; ok\n"); 
 118:	c7 44 24 04 87 08 00 	movl   $0x887,0x4(%esp)
 11f:	00 
 ...
 139:	c7 44 24 04 10 09 00 	movl   $0x910,0x4(%esp)
 140:	00 
 ...
 152:	c7 44 24 04 94 08 00 	movl   $0x894,0x4(%esp)
 159:	00 
 ...
 166:	e8 47 02 00 00       	call   3b2 <exit>
    printf(2, "large: cannot re-open large.file for reading\n");
 16b:	c7 44 24 04 c0 08 00 	movl   $0x8c0,0x4(%esp)
 172:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 499:	0f b6 92 47 09 00 00 	movzbl 0x947(%edx),%edx
  }while((x /= base) != 0);
 ...
 50e:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 62f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 631:	b8 40 09 00 00       	mov    $0x940,%eax
 ...
 6f1:	a1 c0 0b 00 00       	mov    0xbc0,%eax
{
 ...
 737:	89 10                	mov    %edx,(%eax)
  freep = p;
 739:	a3 c0 0b 00 00       	mov    %eax,0xbc0
}
 73e:	5b                   	pop    %ebx
 73f:	5e                   	pop    %esi
 740:	5f                   	pop    %edi
 ...
 75f:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 762:	a3 c0 0b 00 00       	mov    %eax,0xbc0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 789:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 78c:	8b 1d c0 0b 00 00    	mov    0xbc0,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7c9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 7cb:	3b 15 c0 0b 00 00    	cmp    0xbc0,%edx
 ...
 7fd:	e8 ee fe ff ff       	call   6f0 <free>
  return freep;
 802:	8b 15 c0 0b 00 00    	mov    0xbc0,%edx
 ...
 83c:	eb e9                	jmp    827 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 83e:	c7 05 c0 0b 00 00 c4 	movl   $0xbc4,0xbc0
 845:	0b 00 00 
    base.s.size = 0;
 848:	ba c4 0b 00 00       	mov    $0xbc4,%edx
    base.s.ptr = freep = prevp = &base;
 84d:	c7 05 c4 0b 00 00 c4 	movl   $0xbc4,0xbc4
 854:	0b 00 00 
    base.s.size = 0;
 857:	c7 05 c8 0b 00 00 00 	movl   $0x0,0xbc8
 85e:	00 00 00 
